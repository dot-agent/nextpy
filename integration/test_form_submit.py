        ...
        return xt.vstack(
            ...
            xt.form(
                xt.vstack(
                    ...
                    xt.checkbox(id="bool_input3"),
                    xt.switch(id="bool_input4"),
...
def FormSubmitName():
    ...
    def index():
        return xt.vstack(
            ...
            xt.form(
                xt.vstack(
                    xt.input(name="name_input"),
                    xt.hstack(xt.pin_input(length=4, name="pin_input")),
                    xt.number_input(name="number_input"),
                    xt.checkbox(name="bool_input"),
                    xt.switch(name="bool_input2"),
                    xt.checkbox(name="bool_input3"),
                    xt.switch(name="bool_input4"),
                    xt.slider(name="slider_input"),
                    xt.range_slider(name="range_input"),
                    xt.radio_group(FormState.options, name="radio_input"),
                    xt.select(FormState.options, name="select_input"),
                    xt.text_area(name="text_area_input"),
                    xt.input_group(
                        xt.input_left_element(xt.icon(tag="chevron_right")),
                        xt.input(
                            name="debounce_input",
                            debounce_timeout=0,
                            on_change=xt.console_log,
                        ),
                        xt.input_right_element(xt.icon(tag="chevron_left")),
                    ),
                    xt.button_group(
                        xt.button("Submit", type_="submit"),
                        xt.icon_button(FormState.val, icon=xt.icon(tag="add")),
                        variant="outline",
                        is_attached=True,
                    ),
                ),
