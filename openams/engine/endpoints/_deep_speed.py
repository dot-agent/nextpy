...
"""A DeepSpeed accelerated language model"""
    ...
    def __init__(
        ...
        **deep_speed_kwargs
        ...
        assert (
            False
        ), "DeepSpeed does not yet work! (this class is a work in progress and is currently waiting on supporting changes in DeepSpeed)"
        ...
        if self.wrapped_model_obj is None:
            self.wrapped_model_obj = deepspeed.init_inference(
                self.model_obj, **deep_speed_kwargs
            )
