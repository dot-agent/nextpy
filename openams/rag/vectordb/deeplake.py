...
# from openams.rag.vectordb.utils import maximal_marginal_relevance
...
class DeepLake(VectorDB):
    ...
    Example:
        .. code-block:: python
                ...
                from openams.rag.vectordb import DeepLake
                from openams.embeddings.openai import OpenAIEmbeddings

                embeddings = OpenAIEmbeddings()
                vectordb = DeepLake("openams_db_path", embeddings.embed_query)
    """
