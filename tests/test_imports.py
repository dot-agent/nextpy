...
@pytest.mark.parametrize(
    ...
    [
        (
            ReactImportVar(tag="BaseTag"),
            "BaseTag",
        ),
        (
            ReactImportVar(tag="BaseTag", alias="AliasTag"),
            "BaseTag as AliasTag",
        ),
        (
            ReactImportVar(tag="BaseTag", is_default=True),
            "BaseTag",
        ),
        (
            ReactImportVar(tag="BaseTag", is_default=True, alias="AliasTag"),
            "AliasTag",
        ),
        (
            ReactImportVar(tag="BaseTag", is_default=False),
            "BaseTag",
        ),
        (
            ReactImportVar(tag="BaseTag", is_default=False, alias="AliasTag"),
            "BaseTag as AliasTag",
        ),
    ],
)
