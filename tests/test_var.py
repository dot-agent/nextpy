...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            'testing f-string with $<nextpy.Var>{"state": "state", "imports": {"/utils/context": [{"tag": "StateContexts", "is_default": false, "alias": null, "install": true, "render": true}], "react": [{"tag": "useContext", "is_default": false, "alias": null, "install": true, "render": true}]}, "hooks": ["const state = useContext(StateContexts.state)"]}</nextpy.Var>{state.myvar}',
        ),
        (
