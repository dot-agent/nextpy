...
class MainState(State):
    ...
    # OPENAI_API_MODEL OPTIONS
    model_options: list[str] = [
            "gpt-4-0613", "gpt-3.5-turbo", "gpt-3.5-turbo-16k", "gpt-3.5-turbo-0301", "gpt-4", "gpt-3.5-turbo-16k-0613", "gpt-3.5-turbo-0613",
            "gpt-4-0314","gpt-3.5-turbo-1106", "gpt-4-1106-preview"
        ]

    data: dict = {}

    def handle_openai_details(self, data):
        return xt.redirect('/nextpy_gpt')
