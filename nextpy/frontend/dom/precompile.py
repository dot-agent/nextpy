...
This script generates the element classes in the nextpy.components.dom.elements module.
Run as follows:

    python -m nextpy.components.dom.precompile
...
INIT_PY = [
    ...
    "",
    "from nextpy.dom.element import Element",
