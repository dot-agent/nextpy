...
class Next(SimpleNamespace):
    ...
    # print("SITEMAP_CONFIG_FILE: ",SITEMAP_CONFIG_FILE)

    # Temp jokes till we improve compilation time
    import pyjokes
    ...
    # Regex to check for message displayed when frontend comes up. Regex to match the word "Local:" followed by whitespace, then capture the rest of the line.
...
RELOAD_CONFIG = "__NEXTPY_RELOAD_CONFIG"
