...
def compile_import_statement(fields: list[imports.ReactImportVar]) -> tuple[str, list[str]]:
    ...
    """
    # ignore the ReactImportVar fields with render=False during compilation
