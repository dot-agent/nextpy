...
from nextpy.interfaces.web.react_components.recharts.general import ResponsiveContainer
...
class ChartBase(RechartsCharts):
    ...
    # If any two categorical charts(xt.line_chart, xt.area_chart, xt.bar_chart, xt.composed_chart) have the same sync_id, these two charts can sync the position GraphingTooltip, and the start_index, end_index of Brush.
    sync_id: Var[str]
