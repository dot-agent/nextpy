...
from nextpy.interfaces.web.react_components.radix.primitives.base import RadixPrimitiveComponent
from nextpy.interfaces.web.react_components.radix.themes.components.icons import Icon
...
class AccordionContent(AccordionComponent):
    ...
    def _get_imports(self):
        return {
            **super()._get_imports(),
            "@emotion/react": [imports.ReactImportVar(tag="keyframes")],
        }
