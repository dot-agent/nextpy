...
from nextpy.interfaces.web.react_components.literals import LiteralRowMarker
...
class DataEditor(NoSSRComponent):
    ...
    def _get_imports(self):
        return imports.merge_imports(
            super()._get_imports(),
            {
                ...
                self.library: {ReactImportVar(tag="GridCellKind")},
    ...
    def create(cls, *children, **props) -> Component:
        ...
        Returns:
            The DataEditor component.&
        """
        from nextpy.interfaces.web.react_components.el import Div
