...
This script generates the element classes in the nextpy.interfaces.web.react_components.el.elements module.
Run as follows:

    python -m nextpy.interfaces.web.react_components.el.precompile
...
from nextpy.utils import path_ops
...
INIT_PY = [
    ...
    "",
"from nextpy.interfaces.web.react_components.el.element import Element",
