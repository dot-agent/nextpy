...
from nextpy.interfaces.web.react_components.core.debounce import DebounceInput
from nextpy.interfaces.web.react_components.literals import LiteralInputType
...
class Input(ChakraComponent):
    ...
    def _get_imports(self) -> imports.ImportDict:
        return imports.merge_imports(
            super()._get_imports(),
            {"/utils/state": {imports.ReactImportVar(tag="set_val")}},
        )
