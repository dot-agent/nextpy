...
from nextpy.interfaces.web.react_components.chakra.layout import Box
from nextpy.interfaces.web.react_components.chakra.overlay.modal import Modal
from nextpy.interfaces.web.react_components.chakra.typography import Text
...
class WebsocketTargetURL(Bare):
    ...
    def _get_imports(self) -> imports.ImportDict:
        return {
            "/utils/state.js": [imports.ReactImportVar(tag="getEventURL")],
        }
