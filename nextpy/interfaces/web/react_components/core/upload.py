...
from nextpy.interfaces.web.react_components.chakra.forms.input import Input
...
upload_files_context_var_data: VarData = VarData(  # type: ignore
    imports={
        "react": {imports.ReactImportVar(tag="useContext")},
        f"/{Dirs.CONTEXTS_PATH}": {
            imports.ReactImportVar(tag="UploadFilesContext"),
        },
    },
    hooks={
