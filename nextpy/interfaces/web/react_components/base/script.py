...
class Script(Component):
    ...
    Note that this component differs from nextpy.interfaces.web.react_components.base.document.NextScript
    in that it is intended for use with custom and user-defined scripts.

    It also differs from nextpy.interfaces.web.react_components.base.link.ScriptTag, which is the plain
