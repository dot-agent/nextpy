...
expander_button = ExpanderButton.create
expander_icon = ExpanderIcon.create
expander_item = ExpanderItem.create
expander_panel = ExpanderPanel.create
fade = Fade.create
flex = Flex.create
form = Form.create
...
select_slider = RangeSlider.create
