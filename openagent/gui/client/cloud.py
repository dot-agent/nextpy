...
from openagent.gui.client.base import MessageDict, UserDict
...
class GraphQLClient:
    def __init__(self, project_id: str, access_token: Optional[str]):
        ...
        graphql_endpoint = f"{config.gui_server}/api/graphql"
