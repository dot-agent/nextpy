...
# from openagent.rag.vectordb.utils import maximal_marginal_relevance
...
class DeepLake(VectorDB):
    ...
    Example:
        .. code-block:: python
                ...
                from openagent.rag.vectordb import DeepLake
                from openagent.embeddings.openai import OpenAIEmbeddings

                embeddings = OpenAIEmbeddings()
                vectordb = DeepLake("openagent_db_path", embeddings.embed_query)
    """
