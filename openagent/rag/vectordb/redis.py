...
from openagent.rag.vectordb.embeddings.base import Embeddings
...
class Redis(VectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from openagent.rag.vectordb import Redis
            from openagent.embeddings import OpenAIEmbeddings
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        """Add more texts to the vectordb.

        Args:
            texts (Iterable[str]): Iterable of strings/text to add to the vectordb.
        ...
        Returns:
            List[str]: List of ids added to the vectordb
        """
        ids = []
        prefix = _redis_prefix(self.index_name)

        # Get keys or ids from kwargs
        # Other vectordb use ids
    ...
    def similarity_search(
        ...
        query: str, 
        k: int = 4,
        score_threshold: Optional[float] = sys.maxsize, 
        **kwargs
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        """Create a Redis vectordb from raw documents.
