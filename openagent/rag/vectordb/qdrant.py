...
from openagent.rag.vectordb import VectorDB
...
class Qdrant(VectorDB):
    ...
    Example:
        .. code-block:: python
            ...
            from openagent.rag.vectordb import Qdrant
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        results = self.client.search(
            ...
            offset=offset,
            with_payload=True,
            with_vectors=False,  # openagent does not expect vectors to be returned
