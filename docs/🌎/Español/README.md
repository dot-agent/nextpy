...
Comienza importando `nextpy` para el desarrollo y `pyjokes` para chistes aleatorios.
...
Configura la aplicación, agrega la página principal. Para ver el frontend, navega a `localhost:3000`.
